      ...
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            ...
            <Input placeholder="Search invoices, clients..." className="pl-10 bg-muted/50" />
          </div>
        </div>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">Invoice #1001 is 5 days overdue</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">New Payment Received</p>
                  <p className="text-xs text-muted-foreground">₹25,000 from Client ABC</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Invoice Viewed</p>
                  <p className="text-xs text-muted-foreground">Client XYZ viewed invoice #1003</p>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
