    ...
    <>
      <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
        <CardContent className="p-6 text-center">
          ...
          <h2 className="text-lg font-semibold text-primary mb-2">Create New Invoice</h2>

          <p className="text-sm text-muted-foreground mb-4">Start by creating and sending new invoice</p>
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full text-primary border-primary/30 bg-transparent">
